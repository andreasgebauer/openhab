...
import de.gebauer.homematic.AbstractMessage;
 ...
 * 
 */
public class DimCommand extends AbstractMessage {
     ...
     * @param state
     */
    public DimCommand(AbstractDevice srcDevice, AbstractDevice dstDevice, boolean state) {
	super(getMessage(state), srcDevice, dstDevice, (short) 1);
    }
     ...
     * @param dimFactor
     */
    public DimCommand(AbstractDevice srcDevice, AbstractDevice dstDevice, int dimFactor) {
	super(getMessage(dimFactor), srcDevice, dstDevice, (short) 1);
    }
